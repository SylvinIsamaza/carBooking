...
function Register() {
  return (
    <div className="600px:w-[60%] w-full max-w-[540px] py-10 rounded-2xl shadow-sm bg-white 600px:px-6 px-8">
      ...
      <div className="flex flex-col gap-2 justify-start ">
        <p className='text-gray-100  font-[600]'>Confirm password</p>
        <input type="password" placeholder='Confirm password' className='w-full h-[50Px] border-[#CACACA] border-[2.3px] rounded-[13px] px-3' />
        </div>
      
        <Link href="/register" className='flex items-center justify-center py-4 bg-primary-blue rounded-[13px] text-white font-[800] mb-4 mt-10'>Register</Link>
